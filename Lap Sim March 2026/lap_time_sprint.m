function [Time] = lap_time_sprint(path_positions, r_min, r_max, cornering, accel, deccel, lateral, shift_points, shift_time, top_speed)
interval = 5;
sections = 3000;
%tic
...
if isempty(path_boundaries)
    error('path_boundaries_ax is empty. Load autocross track coordinates before calling lap_time_sprint.');
end
