function [Time] = lap_time(path_positions, r_min, r_max, cornering, accel, deccel, lateral, shift_points, shift_time, top_speed)
interval = 5;
sections = 3000;
%tic
pb = load('path_boundaries_end.mat');
path_positions(end+1) = path_positions(1);
path_positions(end+1) = path_positions(2);
path_boundaries = pb.path_boundaries;
% r_min = load('r_min.mat');
% r_min = r_min.r_min;
% r_max = load('r_max.mat');
% r_max = r_max.r_max;
% cornering = load('cornering.mat');
% accel = load('accel.mat');
% deccel = load('deccel.mat');
% lateral = load('lateral.mat');
% shift_points = load('shift_points.mat');
% top_speed = load('top_speed.mat');
VMAX = top_speed;
...
cornering = cornering;
lateral = lateral;
% shift_time = load('shift_time.mat');
% shift_time = shift_time.shift_time;
